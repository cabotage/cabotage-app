...
def upgrade():
    ...
    op.add_column('deployments', sa.Column('job_id', sa.String(length=64), nullable=True))
    op.add_column('deployments_version', sa.Column('job_id', sa.String(length=64), autoincrement=False, nullable=True))
