...
def upgrade():
    ...
    op.add_column(
        ...
        sa.Column(
            "permissions",
            flask_security.datastore.AsaList(),
            autoincrement=False,
            nullable=True,
        ),
    )
    ...
    op.add_column(
        "users", sa.Column("us_phone_number", sa.String(length=128), nullable=True)
    )
    op.create_unique_constraint(
        op.f("uq_users_fs_webauthn_user_handle"), "users", ["fs_webauthn_user_handle"]
    )
    op.create_unique_constraint(
        op.f("uq_users_us_phone_number"), "users", ["us_phone_number"]
    )
    op.add_column(
        "users_version",
        sa.Column(
    ...
    op.add_column(
        "users_version",
        sa.Column(
            "tf_totp_secret", sa.String(length=255), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "users_version",
        sa.Column(
            "tf_phone_number", sa.String(length=128), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "users_version",
    ...
    op.add_column(
        "users_version",
        sa.Column("us_totp_secrets", sa.Text(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "users_version",
        sa.Column(
    ...
    op.add_column(
        "users_version",
        sa.Column(
            "us_phone_number", sa.String(length=128), autoincrement=False, nullable=True
        ),
    )
...
def downgrade():
    ...
    op.drop_constraint(
        op.f("uq_users_fs_webauthn_user_handle"), "users", type_="unique"
    )
