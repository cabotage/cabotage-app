"""create audit_log view

Revision ID: 14392342a190
Revises: 484a6a1954ea
Create Date: 2026-03-28 21:07:27.769718
...
revision = "14392342a190"
down_revision = "484a6a1954ea"
branch_labels = None
depends_on = None
...
-- Deployment (exclude complete/error — those are status changes, not user actions)
SELECT a.id, t.issued_at,
