"""fix audit_log view to show deleted configurations

The Configuration branch previously used an INNER JOIN to the live
project_app_configurations table, which silently dropped delete activities
since the row no longer exists.  Switch to joining the version table
(which preserves all historical records) with a LEFT JOIN fallback to the
live table for scoping.

Revision ID: 16eacbf52ea4
Revises: 14a512703000
Create Date: 2026-03-31 19:46:38.789252
...
revision = "16eacbf52ea4"
down_revision = "14a512703000"
branch_labels = None
depends_on = None
