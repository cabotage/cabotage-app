...
def upgrade():
    ...
    op.add_column('project_applications', sa.Column('github_environment_name', sa.Text(), nullable=True))
    op.add_column('project_applications_version', sa.Column('github_environment_name', sa.Text(), autoincrement=False, nullable=True))
