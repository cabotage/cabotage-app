...
def upgrade():
    ...
    op.add_column('project_app_configurations', sa.Column('build_key_slug', sa.Text(), nullable=True))
    ...
    op.add_column('project_app_configurations_version', sa.Column('buildtime', sa.Boolean(), autoincrement=False, nullable=True))
    op.add_column('project_app_configurations_version', sa.Column('build_key_slug', sa.Text(), autoincrement=False, nullable=True))
